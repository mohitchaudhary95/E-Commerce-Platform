...
using ECommerce.Inventory.Infrastructure.RabbitMQ.Consumers;
using ECommerce.Inventory.Infrastructure.RabbitMQ.Publishers;
...
builder.Services.AddMediatR(cfg =>
    cfg.RegisterServicesFromAssembly(typeof(SetStockCommand).Assembly));

builder.Services.AddScoped<IInventoryRepository, InventoryRepository>();

builder.Services.Configure<RabbitMQSettings>(builder.Configuration.GetSection("RabbitMQ"));
builder.Services.AddSingleton<IEventPublisher, RabbitMQPublisher>();
builder.Services.AddScoped<IInventoryEventPublisher, InventoryUpdatedPublisher>();
